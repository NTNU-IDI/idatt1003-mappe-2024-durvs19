...
public class GroceryService {
   ...
   * @example Grocery grocery = new Grocery(); grocery.setExpiryDate(LocalDate.of(2021, 10, 1));
   ...
   * @example Grocery grocery = new Grocery(); grocery.setQuantity(10);
   ...
   * @example Grocery grocery1 = new Grocery(); grocery1.setName("Apple"); grocery1.setUnit("kg");
